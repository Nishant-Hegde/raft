...
const file_transport_proto_rawDesc = "" +
	"\n" +
	"\x0ftransport.proto\x12\ttransport\x1a\x11raftpb/raft.proto\"\x05\n" +
	"\x03Ack2?\n" +
	"\rRaftTransport\x12.\n" +
	"\vSendMessage\x12\x0f.raftpb.Message\x1a\x0e.transport.AckB*Z(go.etcd.io/raft/v3/node-server/transportb\x06proto3"
...
var file_transport_proto_goTypes = []any{
	(*Ack)(nil),            // 0: transport.Ack
	(*raftpb.Message)(nil), // 1: raftpb.Message
}
var file_transport_proto_depIdxs = []int32{
	1, // 0: transport.RaftTransport.SendMessage:input_type -> raftpb.Message
	0, // 1: transport.RaftTransport.SendMessage:output_type -> transport.Ack
