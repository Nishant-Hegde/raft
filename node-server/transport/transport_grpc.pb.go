...
const (
	RaftTransport_SendMessage_FullMethodName = "/transport.RaftTransport/SendMessage"
)
...
type RaftTransportClient interface {
	SendMessage(ctx context.Context, in *raftpb.Message, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *raftTransportClient) SendMessage(ctx context.Context, in *raftpb.Message, opts ...grpc.CallOption) (*Ack, error) {
...
type RaftTransportServer interface {
	SendMessage(context.Context, *raftpb.Message) (*Ack, error)
...
func (UnimplementedRaftTransportServer) SendMessage(context.Context, *raftpb.Message) (*Ack, error) {
